...
async function main() {
  console.log("🧪 Uruchamianie automatycznego testu weryfikacyjnego: Gantt ↔ Kalendarz...");
  try {
    const result = await client.mutation(api.testing_gantt_calendar.testGanttCalendarIntegration, {});
